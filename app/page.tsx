      ...
      <section className="py-20 bg-navy">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-white/70 text-lg mb-8 max-w-2xl mx-auto">
            Parti dalla prima stima orientativa. Se la forbice è compatibile con il tuo intervento,
            organizziamo il sopralluogo e prepariamo una proposta tecnica chiara e verificata.
          </p>
