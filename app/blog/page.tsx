      ...
      <section className="py-20 bg-navy">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-white/80 text-lg mb-8 max-w-2xl mx-auto">
            Contattaci su WhatsApp per una prima verifica orientativa della tua ristrutturazione. Il sopralluogo serve a confermare misure, lavorazioni e criticità reali.
          </p>
          <a
