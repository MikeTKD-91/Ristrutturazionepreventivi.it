...
export const metadata: Metadata = {
  ...
  description: "Scopri i nostri 7 servizi di ristrutturazione: appartamento, cucina, bagno, tetto, pavimenti, impianti e cappotto termico. Prima verifica orientativa basata sul Prezzario Regionale Campania.",
  alternates: {
    canonical: "https://ristrutturazionepreventivi.it/servizi/",
  },
  openGraph: {
    title: "Servizi di Ristrutturazione | Napoli Caserta",
    description: "7 servizi di ristrutturazione per la tua casa. Prima verifica orientativa basata sul Prezzario Regionale Campania.",
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto mb-8">
            Contattaci su WhatsApp per una prima verifica del progetto. Ti aiutiamo a capire quale servizio è più adatto e quando serve un sopralluogo tecnico.
          </p>
          <a
