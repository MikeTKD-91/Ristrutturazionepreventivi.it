          ...
          <div className="lg:col-span-2 space-y-16">
            ...
            <section>
              ...
              <div className="grid md:grid-cols-3 gap-6">
                {[
                  { step: "01", titolo: "Prima stima online", testo: "Inserisci la superficie della facciata nel modulo di stima o scrivici su WhatsApp per ricevere una prima stima online. È una prima indicazione utile per capire se la spesa è in linea con il budget, ma non sostituisce il sopralluogo tecnico." },
